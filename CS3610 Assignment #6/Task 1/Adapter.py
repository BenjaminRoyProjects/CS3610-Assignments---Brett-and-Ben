...
class Adapter(ForecastSensors):
    ...
    def binToXML(self, data: Type[bytes]):
        ...
        #Convert the XML tree into an XML string
        strXMLData = ElTree.tostring(tempdata, encoding="unicode")
        return strXMLData
